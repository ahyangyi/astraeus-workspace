# Grabbed from here:
#   https://raw.githubusercontent.com/tensorflow/tensorflow/master/third_party/jpeg/BUILD.bazel
# Description:
...
JCONFIG_NOWIN_COMMON_SUBSTITUTIONS = {
    ...
    "#cmakedefine MEM_SRCDST_SUPPORTED": "#define MEM_SRCDST_SUPPORTED",
    "@BITS_IN_JSAMPLE@": "8",
    "#cmakedefine HAVE_LOCALE_H": "#define HAVE_LOCALE_H",
    "#cmakedefine HAVE_STDDEF_H": "#define HAVE_STDDEF_H",
    "#cmakedefine HAVE_STDLIB_H": "#define HAVE_STDLIB_H",
    "#cmakedefine NEED_SYS_TYPES_H": "#define NEED_SYS_TYPES_H",
    "#cmakedefine NEED_BSD_STRINGS 1": "",
    "#cmakedefine HAVE_UNSIGNED_CHAR": "#define HAVE_UNSIGNED_CHAR",
    "#cmakedefine HAVE_UNSIGNED_SHORT": "#define HAVE_UNSIGNED_SHORT",
